...
- (NSOperatingSystemVersion)operatingSystemVersion {
    ...
    spoofedVersion.majorVersion = 17;
    spoofedVersion.minorVersion = 0;
    spoofedVersion.patchVersion = 0;
...
%hook MIBundle
- (BOOL)_isMinimumOSVersion:(id)arg1 applicableToOSVersion:(id)arg2 requiredOS:(id*)arg3 error:(id*)arg4 {
    return YES;
}
%end
